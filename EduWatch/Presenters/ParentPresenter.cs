...
namespace EduWatch.Presenters
{
    public class ParentPresenter : IParentPresenter
    {
        ...
        List<Views.GradeViewData> dataForGridView;
        ...
        internal void OnSubjectSelection()
        {
            ...
            dataForGridView = currentGrades.Select(x => new Views.GradeViewData { ID = x.grade_id, Grade = (int)x.grade1, Seen = (bool)x.grade_seen, Comment = x.comment, Date = x.date.ToLongDateString() }).ToList();
