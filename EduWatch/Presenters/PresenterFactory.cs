...
namespace EduWatch.Presenters
{
    public static class PresenterFactory
    {
        ...
        public static IEditPresenter GetEditPresenter(Views.IEditView view, Model.SchoolDBEntities data, Model.IUser currentUser) => new EditPresenter(view, data, currentUser);
    }
}
